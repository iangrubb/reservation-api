defmodule ReservationsApiWeb.RoomControllerTest do
  ...
  @create_attrs %{
    ...
    occupancy: 42,
    price: 42,
    room_letter: "some room_letter"
  }
  @update_attrs %{
    floor: 43,
    occupancy: 43,
    price: 43,
    room_letter: "some updated room_letter"
  }
  @invalid_attrs %{floor: nil, occupancy: nil, price: nil, room_letter: nil}

  def fixture(:room) do
    {:ok, room} = Reservation.create_room(@create_attrs)
    room
  end
